package wang.androids.plugindev.modulea.activity;
...
import wang.androids.plugindev.modulea.R;
...
public class TestActivity extends AppBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hello.setText("ModuleA TestActivity Hello");
        ...
        findViewById(R.id.astartmain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(TestActivity.this, "没有安装main模块", Toast.LENGTH_SHORT).show();
                }
        ...
        findViewById(R.id.astartb).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(TestActivity.this, "没有安装moduleb模块", Toast.LENGTH_SHORT).show();
                }
